...
public class ScrollableStackView: NSView {
    ...
    public static let defaultLayoutDirection: NSUserInterfaceLayoutOrientation = .horizontal
    ...
    public init(layoutOrientation: NSUserInterfaceLayoutOrientation = ScrollableStackView.defaultLayoutDirection) {
    ...
    public let underlyingStackView = NSStackView()
